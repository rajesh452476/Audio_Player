...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\rajes\Envs\djangoProjects'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('djangoProjects' == '') {
...
alias deactivate = source 'C:\Users\rajes\Envs\djangoProjects\Scripts\deactivate.nu'
